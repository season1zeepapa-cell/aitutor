...
//
// 2026-04-26 재설계 — 데스크탑 WebGPU 에서 E2B/E4B 정상 동작 확인 후 프리셋 정비.
// MediaPipe 시절 과한 "다국어 금지" 제약은 모델 품질 저하 유발 → 완화.
...
/**
 * Transformers.js / OpenAI 호환 messages 배열
 * processor.apply_chat_template(messages, { add_generation_prompt: true }) 에 그대로 전달
 */
...
/**
 * 디버깅 / 미리보기 — chat template 적용 전 raw 형식
 * UI 의 "🔍 최종 입력 프롬프트 보기" 토글에서 사용.
 */
